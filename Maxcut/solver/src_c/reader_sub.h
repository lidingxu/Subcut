...
/**@file   reader_sub.h
 * @brief  submodular problem file reader (to implement)
 * @author Liding Xu
 *
 */
...
#ifndef __SCIP_READER_SUB_H__
#define __SCIP_READER_SUB_H__
...
/** SCIP file reader for Submodular data files */
class ReaderSubmodular : public scip::ObjReader
{
public:
	/** default constructor */
	ReaderSubmodular(SCIP* scip)
		: scip::ObjReader(scip, "reader", "file reader for max cut files", "cut")
	{}
