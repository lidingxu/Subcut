...
algorithms=("defaulta" "icutsaa" "icutsda" "icutsla" "defaultd" "icutsad" "icutsdd" "icutsld")
datapath="benchmark"
logpath="logs"
...
runInstance() {
    ...
    solver/build/multi -c "set limits time $timelimit" -c  "set load $settingpath/$algo.set" -c  "read $datapath/$instance" -c "opt write statistics" -c "$logpath/${instance}_${algo}.log"  -c "quit"
